    ...
    methods: {
      ...
      changeSubmit() { //选择题题库提交
        ...
        this.$axios({ //提交数据到选择题题库表
          url: '/multiQuestion/MultiQuestion',
          method: 'post',
          data: {
            ...this.postChange
          }
          ...
          this.$axios(`/multiQuestion/multiQuestionId`).then(res => { //获取当前题目的questionId
      ...
      fillSubmit() { //填空题提交
        ...
        this.$axios({
          ...
          this.$axios(`/fillQuestion/fillQuestionId`).then(res => { //获取当前题目的questionId
      ...
      judgeSubmit() { //判断题提交
        ...
        this.$axios({
          url: '/judgeQuestion/JudgeQuestion',
          method: 'post',
          data: {
            ...this.postJudge
          }
          ...
          this.$axios(`/judgeQuestion/judgeQuestionId`).then(res => { //获取当前题目的questionId
            let questionId = res.data.data.questionId
            this.postPaper.questionId = questionId
