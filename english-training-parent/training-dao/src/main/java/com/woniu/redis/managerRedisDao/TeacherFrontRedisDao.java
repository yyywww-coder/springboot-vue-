...
@Component
public class TeacherFrontRedisDao {
    ...
    public List<TeacherPo> list() {
        ...
        List<TeacherPo> managerList = new ArrayList<>();
        ...
        try {
            if (!StringUtils.isEmpty(dataStr)){
                ...
                managerList = objectMapper.readValue(dataStr, new TypeReference<List<TeacherPo>>(){});
            }
        }catch (Exception e){
        }
        return managerList;
    ...
    //更新redis
    public void addRedisManagerList(PageInfo<TeacherPo> poPageInfo){
