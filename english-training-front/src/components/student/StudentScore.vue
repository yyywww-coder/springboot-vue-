<template>
  <div class="score">
    <div class="title">
      ...
      <p class="name">奇怪的考试</p>
      <p class="description">(总分：100分,限时：100分钟)</p>
      <p class="description">学生：许可</p>
...
export default {
  data() {
    return {
      ...
      imgSrc: {
        fail1: require("@/assets/images/cry1.gif"),
        fail2: require('@/assets/images/cry2.jpg'),
        pass1: require('@/assets/images/good1.jpg'),
        pass2: require('@/assets/images/good2.gif')
      },
